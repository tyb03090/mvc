...
import com.mvc.repository.BrandListRepository;


public class BrandListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private BrandListRepository blRepo = new BrandListRepository();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = "/WEB-INF/views/brand-list/brand-list.jsp";
